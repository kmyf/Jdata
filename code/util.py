...
def load_data():
    sku_info = pd.read_csv(r'../../../data_test/jdata_sku_basic_info.csv')
    user_action = pd.read_csv(r'../../../data_test/jdata_user_action_new.csv')
    user_info = pd.read_csv(r'../../../data_test/jdata_user_basic_info.csv')
    user_comment = pd.read_csv(r'../../../data_test/jdata_user_comment_score.csv')
    user_order = pd.read_csv(r'../../../data_test/jdata_user_order_new.csv')
    ...
    one_hot_feature = ['para_2', 'para_3']
    action = pd.get_dummies(action, columns=one_hot_feature)
    order = pd.get_dummies(order, columns=one_hot_feature)
